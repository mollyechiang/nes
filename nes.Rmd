...
```{r nice_print, comment=NA, fig.cap="This is an example of how to use `print()` to create a nice looking display in an R Markdown document of the results of a fitted Bayesian model. Given a stanreg object named `fit_3`, it is created by calling `print(fit_3, detail = FALSE, digits = 2)`."}
